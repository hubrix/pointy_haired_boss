...
Inspired by [Ponytail](https://github.com/DietrichGebert/ponytail)'s persistent, adjustable guidance for coding agents. The repository contains shared rule/profile/report contracts, research, and runnable parser/host experiments. The checker and installable plugin remain under development.
...
Run the contract tests and development spikes with Node and npm (test suite verified on Node 26.8.2 and 22.23.2):
